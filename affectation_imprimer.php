...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(10);
		$this->Cell('',10,'Liste des affectations',0,0,'C');
		$this->Ln(20);
	}
...
$pdf = new PDF();
$header = array('Id affectation', 'id employe', 'id service', 'date debut affectation', 'date fin affectation', 'fonction');

$data = $pdf->LoadData('affectation.txt');
