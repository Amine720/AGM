    ...
    <div class="service">
        ...
        <div class="gestion-service">
            ...
            <div class="update-form">
                <form action="mission-delete-save.php" method="post">
                    ...
                    <?php echo "<input type=text value='$data[titremission]' name=titre disabled />"; ?>

                    <label for="ddm">Date début de la mission</label>
                    <?php echo "<input type=date value=$data[ddm] name=ddm disabled />"; ?>

                    <label for="dftm">Date fin théorique de la mission</label>
                    <?php echo "<input type=date value=$data[dftm] name=dftm disabled />"; ?>

                    <label for="dfrm">Date fin réelle de la mission</label>
                    <?php echo "<input type=date value=$data[dfrm] name=dfrm disabled />"; ?>
