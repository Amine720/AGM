    ...
    <div class="service">
        ...
        <div class="gestion-service">
            ...
            <div class="update-form">
                <form action="activite-update-save.php" method="post">
                    ...
                    <?php echo "<input type=text name=titreactivite value=$data[titreactivite] />"; ?>

                    <label for="ddt">Date de l'activité</label>
                    <?php echo "<input type=date value=$data[da] name=da />"; ?>

                    <label for="dftt">Heure de l'activité</label>
                    <?php echo "<input type=text value=$data[ha] name=ha />"; ?>

                    <label for="idtache">Id tache</label>
                    <?php echo "<input type=text value=$data[idtache] name=idtache />"; ?>

                    <label for="com">Commentaire</label>
                    <?php echo "<textarea name=com>$data[commentaire]</textarea>"; ?>
